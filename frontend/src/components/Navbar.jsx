    ...
    <Link
      ...
      className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
        pathname === to
          ...
          : 'text-white/90 hover:bg-jubilee-700 hover:text-white'
      }`}
    >
      {label}
    </Link>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <div className="ml-4 pl-4 border-l border-jubilee-700 flex items-center gap-3">
              <span className="text-sm text-white/90 hidden lg:block">{user?.name}</span>
              <button
          ...
          <button
            onClick={() => setOpen((v) => !v)}
            className="md:hidden inline-flex items-center justify-center p-2 rounded-md text-white/90 hover:bg-jubilee-700 hover:text-white transition-colors"
        ...
        <div className="md:hidden border-t border-jubilee-700 animate-fade-in">
          <div className="px-4 py-3 space-y-1">
            ...
            <div className="pt-2 mt-2 border-t border-jubilee-700 flex items-center justify-between">
              <span className="text-sm text-white/90 px-3 py-2">{user?.name}</span>
              <button
                onClick={handleLogout}
                className="px-3 py-2 rounded-md text-sm font-medium text-white/90 hover:bg-jubilee-700 hover:text-white transition-colors"
                aria-label="Sign out"
              >
                Sign out
              </button>
